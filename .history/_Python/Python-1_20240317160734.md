...
After you've tried to solve the data problem with Numpy once, the only question next time will be how to translate my data analysis problem into some ndarray operations.
